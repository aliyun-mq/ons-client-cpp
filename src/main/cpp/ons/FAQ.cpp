...
const std::string FAQ::SEND_MSG_TO_BROKER_TIMEOUT = "https://github.com/alibaba/ons/issues/3";
const std::string FAQ::SERVICE_STATE_WRONG = "https://github.com/alibaba/ons/issues/4";
const std::string FAQ::BROKER_RESPONSE_EXCEPTION = "https://github.com/alibaba/ons/issues/5";
