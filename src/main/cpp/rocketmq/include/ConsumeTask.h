...
public:
  ConsumeTask(ConsumeMessageServiceWeakPtr service, std::weak_ptr<ProcessQueue> process_queue, MQMessageExt message);
...
private:
  ...
  static void onForward(std::shared_ptr<ConsumeTask> task, bool successful);
};
